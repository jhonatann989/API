...
class db {
    ...
    protected $user = "roccaone";
    protected $pass = "AabmZMIvCCfec6Pf";
    protected $db   = "roccaone";
        ...
        switch ($array["tipo"]){
            case "SELECT":
                    if($this->validateData($array)){
                        ...
                        echo "{{SELECT}} informacion incompleta: la tabla o la condicion (o ambas), no han sido indicadas.";
                    }
                BREAK;
			...
			case "JOIN":
				if($this->validateData($array)){
						...
						$explodeArray = explode ( "," , $array["datos"]); //se separan los datos. en el caso 2, el array 0 contiene la tabla principal y en el caso 1, el array 0 y 1 contienen la tabla principal, que cuenta con las claves foraneas
						...
						switch (count($explodeArray)) {
							case "2":
								...
								$query = "SELECT * FROM " . $temp[0] . " INNER JOIN " . $explodeArray[1] . " ON " . $explodeArray[0] . " = " . $explodeArray[1] . ".id" ;  
							...
							case "4":
								...
								$query = "SELECT * FROM " . $temp[0][0] . " INNER JOIN " . $explodeArray[2] . " ON " . $explodeArray[0]. " = " . $explodeArray[2] . ".id"
																		. " INNER JOIN " . $explodeArray[3] . " ON " . $explodeArray[1]. " = " . $explodeArray[3] . ".id";
					...
					echo "{{JOIN}} informacion incompleta: la tabla, su formato o la condicion (o todo), no han sido indicados o no estan en el formato adecuado.";
				}
				BREAK;
            ...
            case "INSERT":
                if($this->validateData($array)){
                        ...
                        echo "{{INSERT}} informacion incompleta: la tabla o los datos (o ambos) no han sido proporcionados. 
                              Tenga en cuenta que si la insercion ocurre sin condiciones como en la mayoria de los casos, ésta debe ser '1'";
                    }
                BREAK;
            ...
            case "UPDATE":
                    if($this->validateData($array)){
                        ...
                        echo "{{UPDATE}} informacion incompleta: la tabla, la condicion o los datos no han sido proporcionados. ";
                    }
                BREAK;
            ...
            case "DELETE":
                    if($this->validateData($array)){
                        ...
                        echo "{{DELETE}} informacion incompleta: la tabla o la condicion (o ambas) no han sido proporcionadas.";
                    }
                BREAK;
            
            default:
                echo "operacion de base de datos incorrecta o no permitida.";
                BREAK;
    ...
    function validateData ($array) {
        ...
        switch ($array["tipo"]) {
            ...
            case "SELECT":
			 ...
			 //$array["tabla"] = "tablaOrigen.id_foranea, tablaDestino"
